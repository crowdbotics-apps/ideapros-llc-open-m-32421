...
## Project Structure
    ...
    ├── ideapros_llc_open_m_32421  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_open_m_32421`
...
2. Clone this repo and `cd ideapros_llc_open_m_32421`
